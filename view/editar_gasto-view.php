<?php
    ...
    if ($_SESSION['gasto']==1){
        ...
        if (isset($_GET['id'])){
            ...
            $sql_gasto=mysqli_query($con,"select * from gasto where  id='$gasto_id'");
            $count=mysqli_num_rows($sql_gasto);
            $row=mysqli_fetch_array($sql_gasto);
            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ul class="breadcrumb  pull-right">
                            ...
                            <li class="active">Editar Gastos Corriente</li>
                        </ul>
                        <!--breadcrumbs end -->
                        <br>
                    <h1 class="h1">Editar Gastos Corriente</h1>
                </div>
            </div>
