            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-3 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Presupuesto</h4>
                ...
                <div class="col-12 p-3">
                    <div class="card panel panel-default p-2">
                        <div class="panel-heading">
                            <h3 class="panel-title">Datos Presupuesto Federal diciembre</h3>
...
<script>
    ...
    function load(page){
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'view/ajax/diciembre_presupuesto_ajax.php',
            data: parametros,
...
<script>
    $( "#new_register" ).submit(function( event ) {
     ...
     var parametros = $(this).serialize();
         $.ajax({
                type: "POST",
                url: "view/ajax/agregar/agregar_nombre_presupuesto.php",
                data: parametros,
                 beforeSend: function(objeto){
