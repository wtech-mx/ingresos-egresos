        ...
        <section id="main-content">
            ...
            <div class="row">
                ...
                <div class="col-md-offset-10">
                    <!-- modals
                        <?php
                            /*include "modals/agregar/agregar_excedente.php";
                            include "modals/editar/editar_excedente.php";*/
                        ?>
                     /end modals -->
                ...
                <div class="col-12 p-3">
                    <div class="card panel panel-default p-2">
                        <div class="panel-heading">
                            <h3 class="panel-title">Datos Generales de los excedentes</h3>
...
<script>
    ...
    function load(page){
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'view/ajax/general_excedente_ajax.php',
            data: parametros,
