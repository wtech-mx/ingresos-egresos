<?php
	...
	$errors[]= "<p>Lo sentimos, pero el archivo es demasiado grande. Selecciona logo de menos de 10MB</p>";
		...
		$errors[]= "<p>ID del gasto está vacío.</p>";
	} else{
		/* Fin Validacion*/
		if ($imageFileZise>0){
		...
		$img_update="foto1='view/resources/images/gastosCorriente/$image_name' ";
		    ...
		    $sql = "UPDATE gasto SET $img_update WHERE id='$id';";
		    $query_new_insert = mysqli_query($con,$sql);

    if ($query_new_insert) {
?>
		<img class="img-responsive" src="view/resources/images/gastosCorriente/<?php echo $image_name;?>" alt="Imagen del gasto" data-toggle="modal" data-target="#myModal" style='cursor:pointer'>
		  	...
		  	<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="view/resources/images/gastosCorriente/<?php echo $image_name;?>" class="img-responsive">
					</div>
				</div>
		  	</div>
		</div>
