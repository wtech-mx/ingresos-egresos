...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets/src/images/favicon.png">
    <title><?php echo $nombre_empresa; ?></title>
    <!-- Custom CSS -->
    <link href="assets/src/extra-libs/c3/c3.min.css" rel="stylesheet">
    <link href="assets/src/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="assets/src/extra-libs/jvector/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- Custom CSS -->
