<?php
	...
	if (isset($_GET["id"])){
		$id=$_GET["id"];
		$id=intval($id);
		$sql="select * from excedentes_egresos where id='$id'";
...
?>
      ...
      <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <label for="factura">Num. Factura</label>
              <input disabled type="text" class="form-control" value="<?php echo $factura;?>" id="factura" name="factura">
            </div>
